...
Save dataframe as h2o object and split for training and testing datasets. 
```{r}
...
We ended up with the XGBoost model here. It showed pretty bad performance, though. The AUC parameter (area under the curve) is only 54%, which is only 4% higher than the benchmark. 
